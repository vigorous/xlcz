...
<div class="warp">
    <div class="trace">
        ...
        <a href="javascript:void(0);" class="now">新增</a>
    </div>
    <div class="main">
        <div class="container">
                            ...
                            <tr>
                                ...
                                <td width="80%">
                                    <div class="form-input">
                                        <input id="shippingCompany" name="shippingCompany" class="mini-textbox" height="30"
                                               emptyText="请输入船公司名称" value="" maxlength="45" required="true"/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="80%">
                                    <div class="form-input">
                                        <input id="codeRule" name="codeRule" class="mini-textbox" height="30"
                                               emptyText="请输入提单编号规则" value="" maxlength="45" required/>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="80%">
                                    <div class="form-input">
                                        <input id="remark" name="remark" class="mini-textarea" height="30"
                                               emptyText="请输入备注" value="" maxlength="1000"/>
                                    </div>
                                </td>
                            </tr>
                        </table>
